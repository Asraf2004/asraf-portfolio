  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold mb-8 text-white text-center relative inline-block group">
          Experience
        ...
        <div className="mt-12 max-w-3xl mx-auto">
          <div className="glass-card p-6 rounded-lg border border-white/5 hover:border-cyber-neon/30 transition-all duration-300">
